...
- js/avian-game.bundle.js (generated by scripts/build-bundle.js — committed for GitHub Pages)
...
1. Run after pulling if the committed bundle is missing, and after editing any source file: `node scripts/build-bundle.js`. Commit the bundle, hash, and sw.js — avianascent.com serves those files as-is.
