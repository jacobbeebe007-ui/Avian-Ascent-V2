...
check('MASTER_BASE_CRIT_MULT is 1.5', c.MASTER_BASE_CRIT_MULT === 1.5, `got=${c.MASTER_BASE_CRIT_MULT}`);
check('MASTER_MAX_CRIT_MULT is 2.0', c.MASTER_MAX_CRIT_MULT === 2, `got=${c.MASTER_MAX_CRIT_MULT}`);
