...
const staticChecks = [
  ...
  ['nest item stats on worn and bag', /function _nestEquipmentItemHtml[\s\S]*?formatEquipmentCompactStatsHtml[\s\S]*?function buildNestEquipmentSectionV2[\s\S]*?formatEquipmentCompactStatsHtml/],
  ['nest profile columns', /nest-profile-columns/],
  ['combat empty skill reason row', /btn-empty-reason/],
