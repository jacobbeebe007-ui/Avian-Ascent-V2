...
console.log('  - js/ui/combat-stats-modal.js');
console.log('  - js/ui/combat-bars.js');
console.log('  - js/ui/combat-status.js');
console.log('  - js/ui/combat-enemy-telegraph.js');
console.log('  - js/ui/combat-hud.js');
console.log('  - js/ui/combat-actions.js');
