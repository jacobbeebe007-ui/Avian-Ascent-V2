...
- Combat: weapon min–max × ((Skill Power + Stat×2.5)÷100); Max HP = leveled Base Health (½ original BH per level after 1) + Vitality × 3; Agility→Dodge (×0.5%); Guard/Resolve rating mitigation.
